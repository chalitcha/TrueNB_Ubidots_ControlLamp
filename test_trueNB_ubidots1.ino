...
String token = "xxxx-DfwnBUxxxbnpBaSfxxxxxxxxxxxxxx"; // Assign your Ubidots TOKEN
String device_name = "nb002"; // Assign the unique device label (device name)
 ...
 /* if (millis() - start > 60000)  // 1 min
  {
    ...
    data_u = val_name1 + String(data0) + "," + val_name2 + String(data1) + "," + val_name3 + String(lamp_stts);
